package com.sulake.core.assets.loaders
{
   ...
   public class BinaryFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_35:URLLoader;
      
      public function BinaryFileLoader(param1:String, param2:URLRequest = null)
      {
         super();
         this.var_942 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_35 = new URLLoader();
         this.var_35.addEventListener(Event.COMPLETE,loadEventHandler);
         this.var_35.addEventListener(Event.UNLOAD,loadEventHandler);
         this.var_35.addEventListener(HTTPStatusEvent.HTTP_STATUS,loadEventHandler);
         ...
         this.var_35.addEventListener(SecurityErrorEvent.SECURITY_ERROR,loadEventHandler);
         if(param2 != null)
         {
            this.load(param2);
         }
      ...
      {
         return !!this._data ? this._data : (!!this.var_35 ? this.var_35.data : null);
      }
      ...
      {
         this.var_942 = param1.url;
         this._data = null;
         var_292 = 0;
         this.var_35.dataFormat = this._type == "application/octet-stream" ? "null" : URLLoaderDataFormat.TEXT;
         this.var_35.load(param1);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_292 < var_2653)
            {
               ...
               this.var_35.load(new URLRequest(this.var_942 + (this.var_942.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_292));
               return true;
            }
         }
         return false;
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this.var_35.removeEventListener(Event.UNLOAD,loadEventHandler);
            this.var_35.removeEventListener(HTTPStatusEvent.HTTP_STATUS,loadEventHandler);
            ...
            this.var_35.removeEventListener(SecurityErrorEvent.SECURITY_ERROR,loadEventHandler);
            try
            {
               this.var_35.close();
            }
