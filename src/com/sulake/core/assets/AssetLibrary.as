package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1391:String = "AssetLibraryUnloaded";
      
      public static const const_1498:String = "AssetLibraryLoadError";
      
      private static var var_283:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_485:uint = 0;
      ...
      private var var_723:XML;
      
      private var var_890:Boolean;
      
      private var var_398:uint;
      
      private var var_35:LibraryLoader;
      
      private var var_599:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_485;
         this.var_400 = new Dictionary(false);
         this.var_484 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_889.splice(var_889.indexOf(this),1);
            --var_485;
            this.var_484 = null;
            this.var_892 = null;
            this.var_147 = null;
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = true) : void
      {
         ...
         {
            if(!this.var_891 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_723,this.var_599);
            }
            this.var_891 = param2;
         ...
         {
            if(this.var_35 == null || this.var_35.disposed)
            {
               this.var_35 = param1;
               this.var_35.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
               this.var_35.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            }
            this.var_891 = param2;
            this._file = this.var_35.url;
         }
      }
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_484)
         {
            _loc2_ = this.var_484[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_484[_loc1_];
         }
         ...
         this.var_890 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1391));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_892[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(this.var_35 != null)
         {
            if(this.var_35.hasDefinition(param1))
            {
               _loc2_ = this.var_35.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  this.var_892[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_484[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_933,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_961,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1068,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_995,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_484[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_484[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_398;
                     this.var_399.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_484[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_399.length ? this.getAssetByName(this.var_399[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_147)
         {
            ...
            {
               return this.var_399.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_147[param1] != null || (this.var_599 != null ? this.var_599[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_400.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_400[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_400[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_400)
         {
            _loc3_ = AssetTypeDeclaration(this.var_400[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_400)
         {
            _loc4_ = AssetTypeDeclaration(this.var_400[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_723 = _loc2_.manifest.copy();
         this.var_599 = _loc2_.resource;
         ...
         if(this.var_891)
         {
            this.var_35.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
            this.var_35.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            this.var_35.addEventListener(LibraryLoader.LIBRARY_LOADER_FINALIZE,this.finalizeLoaderEventHandler);
            this.var_35 = null;
            this.var_599 = null;
         }
      }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1498));
         this.var_35 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_723.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_599[param1]);
