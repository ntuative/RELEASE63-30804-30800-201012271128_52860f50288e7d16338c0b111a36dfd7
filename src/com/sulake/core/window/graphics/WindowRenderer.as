package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1694:Point;
      
      private var var_1346:Rectangle;
      
      private var var_278:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1694 = new Point();
         this.var_1346 = new Rectangle();
         this.var_278 = new Rectangle();
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_278.x = param2.x - param1.x;
            this.var_278.y = param2.y - param1.y;
            this.var_278.width = param2.width;
            this.var_278.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  this.var_278.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_278,WindowRedrawFlag.const_1085);
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               this.var_278.x = _loc3_.dirty.x;
               this.var_278.y = _loc3_.dirty.y;
               this.var_278.width = _loc3_.dirty.width;
               this.var_278.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_278,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1694,this.var_1346))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1694,this.var_1346))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1346);
