package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1429:uint = 0;
      
      public static const const_799:uint = 1;
      
      public static const const_1026:uint = 2;
      
      public static const const_633:uint = 4;
      
      public static const const_1407:uint = 8;
      
      public static const const_1292:uint = 16;
      
      public static const const_1693:uint = 64;
      
      public static const const_1652:uint = 128;
      
      public static const const_1058:uint = 256;
      
      protected static var var_519:uint = 0;
      
      protected static var var_293:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1407:
               ...
               break;
            case GraphicContext.const_1292:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_633:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1058:
               break;
            case GraphicContext.const_1429:
               break;
            default:
         ...
         if(this.var_774)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_293 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1908,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1908,16777215);
                  }
                  var_293 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_774)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_293 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
