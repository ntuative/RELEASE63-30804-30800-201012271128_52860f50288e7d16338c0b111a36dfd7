package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_891:uint = 8;
      
      private static const const_1255:String = "skin";
      
      private static const const_1254:String = "bitmap";
      
      private static const const_1256:String = "fill";
      
      private static const const_1253:String = "text";
      
      private static const const_1259:String = "shape";
      
      private static const const_1257:String = "unknown";
      
      private static const const_1258:String = "null";
      
      protected static var var_294:Array;
      ...
      private var var_2632:Dictionary;
      
      private var var_2630:Dictionary;
      
      private var var_2631:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2632 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1868,this.var_2632);
         this.var_2630 = new Dictionary();
         this.var_2631 = new Dictionary();
         StateCodeTable.fillTables(this.var_2630,this.var_2631);
         this.var_508 = new Dictionary();
         this.var_508[const_1255] = BitmapSkinRenderer;
         this.var_508[const_1254] = BitmapDataRenderer;
         this.var_508[const_1256] = FillSkinRenderer;
         this.var_508[const_1253] = TextSkinRenderer;
         this.var_508[const_1259] = ShapeSkinRenderer;
         this.var_508[const_1257] = SkinRenderer;
         this.var_508[const_1258] = NullSkinRenderer;
         if(var_294 == null)
         {
            var_294 = new Array();
            var_294.push(WindowState.const_65);
            var_294.push(WindowState.const_69);
            var_294.push(WindowState.const_84);
            var_294.push(WindowState.const_49);
            var_294.push(WindowState.WINDOW_STATE_HOVERING);
            var_294.push(WindowState.const_76);
            var_294.push(WindowState.const_99);
            var_294.push(WindowState.const_92);
         }
         if(param1 != null)
         {
      ...
      {
         if(this.var_934[param1] == null)
         {
            this.var_934[param1] = new Array(const_891);
         }
         this.var_934[param1][param2] = param3;
         if(this.var_935[param1] == null)
         {
            this.var_935[param1] = new Array(const_891);
         }
         this.var_935[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_934[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_267)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_935[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_267)
