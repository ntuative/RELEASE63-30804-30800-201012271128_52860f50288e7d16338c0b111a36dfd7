package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_934:String = "_EXCLUDE";
      
      public static const const_1691:String = "_INCLUDE";
      
      public static const const_1754:String = "_TEMP";
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1179);
         this.var_946 = new Dictionary();
         this.var_1433 = new Dictionary();
         ParamCodeTable.fillTables(this.var_946,this.var_1433);
         this.var_1900 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1165,"");
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1179)
            {
               delete this.var_1179[_loc1_];
            }
            for(_loc1_ in this.var_946)
            {
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1179[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_934) == -1)
                  {
