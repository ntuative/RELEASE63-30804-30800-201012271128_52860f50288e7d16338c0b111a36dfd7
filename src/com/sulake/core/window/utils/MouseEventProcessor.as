package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_143:IWindowRenderer;
      
      protected var var_129:IDesktopWindow;
      
      protected var var_771:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_78 = param1.var_1170 as WindowController;
         this._lastClickTarget = param1.var_1167 as WindowController;
         this.var_143 = param1.renderer;
         this.var_771 = param1.var_1168;
         param2.begin();
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_78 && !this.var_78.disposed)
                     {
                        ...
                        {
                           this.var_771.mouseEventReceived(_loc3_.type,this.var_78);
                        }
                     }
                  }
         ...
         param1.var_1170 = this.var_78;
         param1.var_1167 = this._lastClickTarget;
         param1.renderer = this.var_143;
         param1.var_1168 = this.var_771;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_143.getDrawBufferForRenderable(param1);
