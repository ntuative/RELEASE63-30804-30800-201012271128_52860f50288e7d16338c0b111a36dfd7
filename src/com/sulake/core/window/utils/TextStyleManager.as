package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_316:String = "regular";
      ...
      private static const const_560:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_316],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_316] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_560);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_560))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_560 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1249) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1248) + 2,_loc5_.length);
            }
