package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1128:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1543:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1541:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1542:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
      ...
      protected var var_420:String = "none";
      
      protected var var_216:Boolean = false;
      
      protected var var_948:Boolean = false;
      
      private var var_393:String = "regular";
      
      private var var_202:TextStyle;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_393,this.var_202);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_202.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_202.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_202.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_202.fontSize = param2;
      }
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_216)
         {
            param1.context.removeLocalizationListener(param1.var_56,param1);
            param1.var_216 = false;
         }
         param1.var_56 = param2;
         if(param1.var_56.charAt(0) == "$" && param1.var_56.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_56.slice(2,param1.var_56.indexOf("}")),param1);
            param1.var_216 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_56;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_202.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_202.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_393 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_393,param1.var_202);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_202.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_316);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_999 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_393);
      }
      ...
      {
         this.var_776 = param1;
         this._field.scrollH = this.var_776 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_776 * this.maxScrollH,this.var_513 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_776 = this.var_776;
         _loc1_.var_513 = this.var_513;
         _loc1_.var_79 = this.var_79.clone(_loc1_.setTextMargins);
         _loc1_.var_420 = this.var_420;
         _loc1_.var_216 = this.var_216;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(this.var_420 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_420 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_420 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_420 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_393);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_83,this.defaultTextFormat.font != _loc2_.fontFamily));
         ...
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_167,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_83,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1543));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_83,this._field.gridFitType != GridFitType.PIXEL,const_1541));
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_83,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_212,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_393,PropertyStruct.const_83,this.var_393 != TextStyleManager.const_316,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_212,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_50,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_79.left,PropertyStruct.const_51,this.var_79.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_79.top,PropertyStruct.const_51,this.var_79.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_79.right,PropertyStruct.const_51,this.var_79.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_79.bottom,PropertyStruct.const_51,this.var_79.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_420,PropertyStruct.const_83,this.var_420 != TextFieldAutoSize.NONE,const_1542));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_212,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
