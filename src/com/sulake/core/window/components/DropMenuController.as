package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1126:String = "item_array";
       
      
      private var _itemArray:Array;
      
      private var var_572:int = -1;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_437,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_572 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_360,this,null));
         }
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_160 == null || this.var_160.disposed)
         {
            this.var_160 = context.create(name + "::submenu","",WindowType.const_497,var_77,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_841 = false;
            this.getTitleText().text = this.var_572 < this._itemArray.length && this.var_572 > -1 ? this._itemArray[this.var_572] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_499,var_77,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_377,var_77,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_572 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_572).setStateFlag(WindowState.const_49,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_39 || param1.type == WindowTouchEvent.const_490)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1044:
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowTouchEvent.const_771:
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1126,this._itemArray,PropertyStruct.const_146,this._itemArray.length > 0));
         return _loc1_;
      }
