package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1230:String = "_SELECTOR";
      
      private static const const_1229:String = "_CONTENT";
       
      
      protected var var_949:ITabSelectorWindow;
      
      protected var var_1912:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_949 = findChildByTag(const_1230) as ITabSelectorWindow;
            if(this.var_949 != null)
            {
               this.var_949.procedure = this.selectorEventProc;
            }
         }
         return this.var_949;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1912 = findChildByTag(const_1229) as IWindowContainer;
         }
      ...
      {
         return !!this.var_746 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_949.numSelectables;
      }
