package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1170:String = "_HEADER";
      
      private static const const_1171:String = "_CONTENT";
      
      private static const const_1172:String = "_SCALER";
      
      private static const const_841:String = "margin_left";
      
      private static const const_838:String = "margin_top";
      
      private static const const_839:String = "margin_right";
      
      private static const const_840:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1289:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1289 = findChildByTag(const_1170) as IHeaderWindow;
            if(!this.var_1289)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_153 = findChildByTag(const_1171) as IWindowContainer;
            if(!this.var_153)
            {
      ...
      {
         return findChildByTag(const_1172) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1124,_loc2_,false);
      ...
      {
         return this.content != null && this.var_945 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_268);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_200);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_841,_loc3_.left,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_838,_loc3_.top,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_839,0 - _loc3_.right,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_840,0 - _loc3_.bottom,PropertyStruct.const_51,_loc2_));
         return _loc1_;
      }
