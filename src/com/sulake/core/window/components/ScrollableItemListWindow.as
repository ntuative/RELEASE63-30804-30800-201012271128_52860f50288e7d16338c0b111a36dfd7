package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_380)
         {
            this.var_380.removeEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            this.var_380.removeEventListener(WindowEvent.const_224,this.scrollBarEventProc);
            this.var_380 = null;
         }
         if(this.var_1051)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1051)
         {
            this.var_1051 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_380)
         {
            ...
            if(this.var_380)
            {
               this.var_380.addEventListener(WindowEvent.const_291,this.scrollBarEventProc);
               this.var_380.addEventListener(WindowEvent.const_224,this.scrollBarEventProc);
            }
         }
         return this.var_380;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_224)
         {
            this.hideScrollBar();
         }
      }
