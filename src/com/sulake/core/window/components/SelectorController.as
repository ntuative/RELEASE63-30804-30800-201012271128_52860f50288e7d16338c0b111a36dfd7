package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_174:ISelectableWindow;
      
      protected var var_1911:Boolean = true;
      ...
      {
         return this.var_174 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_174)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_360,this,this.var_174));
               }
            }
         }
      }
