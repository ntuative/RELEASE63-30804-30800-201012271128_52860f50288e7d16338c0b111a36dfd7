package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_649:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_649.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_649.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_649.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_649.remove(param1);
         var_649.add(param1,param2);
      }
      ...
      {
         return var_984[param1];
      }
      
      public static function getParameterNames() : Array
      {
         return var_984.getKeys();
      }
   }
}
