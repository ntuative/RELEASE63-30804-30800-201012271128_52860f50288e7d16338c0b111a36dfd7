package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_704:Number = 64;
      ...
      private var var_1110:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_395:Number = 1.0;
      
      private var var_397:Number = 1.0;
      ...
      private var var_2683:Number = -500.0;
      
      private var var_2684:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1110 = new Vector3d();
         this.var_1747 = 1;
         this.var_1748 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1746 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_75.x * this.var_395,this.var_75.y * this.var_397,this.var_75.z * this.var_396);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_243.x,this.var_243.y,this.var_243.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_395 != param1 * this.var_1747)
         {
            this.var_395 = param1 * this.var_1747;
            ++this.var_146;
         }
      }
      ...
      {
         if(this.var_397 != param1 * this.var_1748)
         {
            this.var_397 = param1 * this.var_1748;
            ++this.var_146;
         }
      }
      ...
      {
         if(this.var_396 != param1 * this.var_1746)
         {
            this.var_396 = param1 * this.var_1746;
            ++this.var_146;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_75.x /= this.var_395;
         this.var_75.y /= this.var_397;
         this.var_75.z /= this.var_396;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_243.x;
         var _loc3_:Number = this.var_243.y;
         var _loc4_:Number = this.var_243.z;
         this.var_243.assign(param1);
         if(this.var_243.x != _loc2_ || this.var_243.y != _loc3_ || this.var_243.z != _loc4_)
         {
            ++this.var_146;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_483 != null)
         {
            ...
            this.var_483.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_483.add(_loc3_,_loc4_);
            ++this.var_146;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_483 != null)
         {
            ...
            return this.var_483.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1110.assign(_loc22_);
         }
         else
         {
            this.var_1110.assign(_loc17_);
         }
         ++this.var_146;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_395;
         _loc2_.y *= this.var_397;
         _loc2_.z *= this.var_396;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1110);
         if(_loc3_ < this.var_2683 || _loc3_ > this.var_2684)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_397;
            _loc2_.z *= this.var_396;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1110);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_75.x * this.var_395,this.var_75.y * this.var_397,this.var_75.z * this.var_396);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_169;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_395,param2.y * this.var_397,param2.z * this.var_396);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_395,param3.y * this.var_397,param3.z * this.var_396);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_395,param4.y * this.var_397,param4.z * this.var_396);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_704;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_704;
      }
