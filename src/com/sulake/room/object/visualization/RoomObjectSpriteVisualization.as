package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_337:IRoomObject;
      
      private var var_1245:IGraphicAssetCollection;
      
      protected var var_422:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_179 != null)
         {
            ...
            {
               _loc1_ = this.var_179[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_179.length > param1)
         {
            _loc2_ = this.var_179[this.var_179.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_179.length)
         {
