package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2712:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_569 = [];
         this.var_568 = [];
         events.addEventListener(RoomContentLoadedEvent.const_367,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_429,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_656,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_567 == null || this.var_451 == null)
         {
            return;
         }
         this._state = const_1481;
         if(this.var_1036 != null)
         {
            _loc1_ = this.var_1036;
            this.var_1036 = null;
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_568.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_568[_loc4_];
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_784)
         {
            return;
         }
         if(this.var_45 == null)
         {
            this._state = const_784;
            return;
         }
         if(this.var_45.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_45 == null || this.var_451 == null)
         {
            return;
         }
