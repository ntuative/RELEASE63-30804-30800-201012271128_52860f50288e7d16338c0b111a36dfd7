   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_235 != null)
         {
            ...
            {
               _loc3_ = this.var_235.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_540)
            {
               delete this.var_540[_loc1_];
            }
            this.var_540 = null;
         }
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(this.var_540[param1] != param2)
         {
            this.var_540[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1230.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         var _loc2_:int = this.var_568.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_568.push(param1);
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_568.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_568[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_143 != null)
            {
               this.var_143.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_143)
               {
                  this.var_143.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_143)
                  {
                     this.var_143.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_143.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      {
         return this.var_235.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_235.getValue(_loc2_) != null)
         {
            return this.var_235.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_235.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_235.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_235.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_235.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
