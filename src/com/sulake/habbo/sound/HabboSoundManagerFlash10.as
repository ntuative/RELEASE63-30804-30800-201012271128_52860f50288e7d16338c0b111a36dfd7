package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_886:TraxSequencer;
      
      private var var_597:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_993,this.onTraxLoadComplete);
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_598.add(_loc4_,param1);
      }
      ...
      {
         if(this._configuration == null || this._connection == null || this._roomEngine == null || this.var_597 != null)
         {
            return;
         }
         this.var_597 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_598.getValue(_loc2_);
         ...
         this.var_598.remove(_loc2_);
         this.var_721.add(_loc3_,_loc6_);
         if(this.var_598.length == 0 && this.var_722 != -1)
         {
            this.var_886.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_993,this.var_722));
            this.var_722 = -1;
            this.var_886 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_597.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1318,this.var_722));
         this.var_722 = -1;
         this.var_886 = null;
      }
      ...
      {
         this.var_482 = param1;
         this.var_597.updateVolume(this.var_482);
