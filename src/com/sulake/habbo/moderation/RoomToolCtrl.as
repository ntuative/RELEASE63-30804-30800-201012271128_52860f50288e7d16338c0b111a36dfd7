package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1004:IDropMenuWindow;
      
      private var var_432:ITextFieldWindow;
      
      private var var_586:Boolean = true;
      
      private var var_879:ICheckBoxWindow;
      
      private var var_1371:ICheckBoxWindow;
      
      private var var_1370:ICheckBoxWindow;
      ...
      {
         this._frame = IFrameWindow(this.var_43.getXmlWindow("roomtool_frame"));
         this.var_43.messageHandler.addRoomInfoListener(this);
         this.var_43.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_303));
         Logger.log("BEGINNING TO SHOW: " + this.var_303);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1267;
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_43.messageHandler.removeRoomEnterListener(this);
         if(this._frame != null)
         {
            this._frame.destroy();
            this._frame = null;
      ...
      {
         var _loc2_:Boolean = this._data != null && this._data.flatId == this.var_43.currentFlatId;
         var _loc3_:IButtonWindow = IButtonWindow(this._frame.findChildByName(param1));
         if(_loc2_ && this.var_43.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_303);
         if(param1.flatId != this.var_303)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_303);
            return;
         }
         this._data = param1;
         this.populate();
         this.var_43.messageHandler.removeRoomInfoListener(this);
         this._frame.visible = true;
         this.var_43.messageHandler.addRoomEnterListener(this);
      ...
      public function populate() : void
      {
         ...
         this.var_432 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_432.procedure = this.onInputClick;
         this.var_1004 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1004);
         this.var_1004.procedure = this.onSelectTemplate;
         this.var_879 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1371 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1370 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
         ...
         this.var_43.disableButton(this.var_43.initMsg.chatlogsPermission,this._frame,"chatlog_but");
         if(!this.var_43.initMsg.roomKickPermission)
         {
            this.var_879.disable();
         }
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(this.var_43.getXmlWindow("roomtool_roomdata"));
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.windowTracker.show(new UserInfoFrameCtrl(this.var_43,this._data.ownerId),this._frame,false,false,true);
      }
      ...
      private function onEnterRoom(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.goToRoom(this._data.flatId);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_43,WindowTracker.const_776,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.openHkPage("roomadmin.url","" + this._data.flatId);
      }
      ...
      {
         if(this.var_586 || this.var_432.text == "")
         {
            this.var_43.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_879.isSelected);
         this.var_43.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1322,_loc2_,this.var_432.text,"",""));
         if(this.var_1371.isSelected || this.var_1370.isSelected || this.var_879.isSelected)
         {
            this.var_43.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1371.isSelected,this.var_1370.isSelected,this.var_879.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1491);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1374);
      }
      ...
      {
         Logger.log("MSG TEMPLATES: " + this.var_43.initMsg.roomMessageTemplates.length);
         param1.populate(this.var_43.initMsg.roomMessageTemplates);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_43.initMsg.roomMessageTemplates[this.var_1004.selection];
         if(_loc3_ != null)
         {
            this.var_586 = false;
            this.var_432.text = _loc3_;
         }
      }
   }
}
