package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_847:int = 60;
      
      private static const const_848:int = 3600;
      
      private static const const_849:int = 86400;
      
      private static const const_850:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         return Math.round(param1 / const_850) + " years ago";
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         this._data = null;
         this.refresh();
         this.var_43.messageHandler.addUserInfoListener(this);
         this.var_43.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_43.messageHandler.removeUserInfoListener(this);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1049.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_43.getXmlWindow("user_info"));
            this.var_1049.addChild(_loc1_);
            this.var_43.disableButton(this.var_43.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_43.disableButton(this.var_43.initMsg.alertPermission,_loc1_,"message_but");
            this.var_43.disableButton(this.var_43.initMsg.alertPermission || this.var_43.initMsg.kickPermission || this.var_43.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_43,WindowTracker.const_1112,this._data.userId),this._callerFrame,this.var_1050,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.windowTracker.show(new RoomVisitsCtrl(this.var_43,this._data.userId),this._callerFrame,this.var_1050,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.openHkPage("habboinfotool.url",this._data.userName);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.windowTracker.show(new SendMsgsCtrl(this.var_43,this._data.userId,this._data.userName,this.var_1228),this._callerFrame,this.var_1050,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_43.windowTracker.show(new ModActionCtrl(this.var_43,this._data.userId,this._data.userName,this.var_1228),this._callerFrame,this.var_1050,false,true);
      }
      ...
      {
         this.var_43.openHkPage("moderatoractionlog.url",this._data.userName);
      }
   }
}
