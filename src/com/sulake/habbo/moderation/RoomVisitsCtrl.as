package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_2628 = IWindowContainer(this.var_43.getXmlWindow("roomvisits_row"));
         this.var_403 = new Timer(300,1);
         this.var_403.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_43.messageHandler.addRoomVisitsListener(this);
         this.var_43.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_43.getXmlWindow("roomvisits_frame"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_43.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_2628.clone());
         ...
         new OpenRoomTool(this._frame,this.var_43,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_43,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
