package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_619 = new IssueBrowser(this,this.var_59.windowManager,this.var_59.assets);
         this.var_1150 = [];
         this.var_1151 = [];
         this.var_756 = new Map();
         this.var_2601 = parseInt(this.var_59.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1847 = new Timer(const_1371,0);
         this.var_1847.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1847.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1150 = this.var_1150.concat(_loc4_.getIssueIds());
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_374 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1151 = this.var_1151.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_59.soundManager.playSound(HabboSoundTypesEnum.const_1118);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1460)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_661);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1151.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2601);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_756.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_756.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
         ...
         for each(_loc4_ in this.var_99)
         {
            switch(param1)
            {
               case const_1053:
                  ...
                  break;
               case const_661:
                  if(_loc4_.state == IssueMessageData.const_374 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_756.remove(param1);
         this.var_756.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_756.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_374 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_756.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
