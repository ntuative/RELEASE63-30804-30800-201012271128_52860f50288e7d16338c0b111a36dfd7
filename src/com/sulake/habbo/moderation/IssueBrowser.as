package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1838:String = "my_issues";
      
      private const const_1839:String = "open_issues";
      
      private const const_1837:String = "picked_issues";
      ...
      private var var_320:IIssueBrowserView;
      
      private var var_1577:IIssueBrowserView;
      
      private var var_1578:IIssueBrowserView;
      
      private var var_1579:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_231 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_231.numTabItems)
            {
               _loc5_ = this.var_231.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_231 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_231 == null || this.var_231.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_231.selector.getSelectableByName("open_issues");
         this.var_231.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_320 == _loc2_)
         {
            return;
         }
         ...
         this.var_320.view.width = this.var_231.container.width;
         this.var_320.view.height = this.var_231.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1838:
               if(this.var_1577 == null)
               {
                  this.var_1577 = new MyIssuesView(this.issueManager,this,this.var_231.container);
               }
               return this.var_1577;
            case this.const_1839:
               if(this.var_1578 == null)
               {
                  this.var_1578 = new OpenIssuesView(this.issueManager,this,this.var_231.container);
               }
               return this.var_1578;
            case this.const_1837:
               if(this.var_1579 == null)
               {
                  this.var_1579 = new PickedIssuesView(this.issueManager,this,this.var_231.container);
               }
