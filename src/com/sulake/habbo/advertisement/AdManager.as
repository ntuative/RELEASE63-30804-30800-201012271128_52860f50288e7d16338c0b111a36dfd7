package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1061:BitmapData = null;
      
      private var var_1062:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2297 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2300 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2299 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1637 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_197 != null && this.var_197.running)
         {
            this.var_197.reset();
            return false;
         }
         if(this.var_1060 == 0)
         {
            this.var_1060 = getTimer();
            return false;
         }
         if(this.var_1637 > 0 && this.var_1639 >= this.var_1637)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1060;
         if(_loc1_ > this.var_2300)
         {
            ++this.var_1639;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1322 = _loc2_.imageUrl;
         this.var_2298 = _loc2_.clickUrl;
         this.var_1060 = getTimer();
         if(this.var_1322 != "")
         {
            _loc3_ = this.var_1322;
            ...
            {
               this.var_197 = new Timer(this.var_2299,1);
               this.var_197.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_197.running)
            {
               this.var_197.reset();
            }
            this.var_197.start();
            _loc4_ = new URLRequest(this.var_1322);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_492,0,0,param1.bitmapData,this.var_2298));
            this.var_1060 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_448));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1323 = _loc2_.imageUrl;
         this.var_1638 = _loc2_.clickUrl;
         if(this.var_1323 != "" && this.var_1638 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1323);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_475,0,0,_loc4_,this.var_1638,this.var_1061,this.var_1062));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1061 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1062 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
