package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_193:Boolean = true;
      
      private static const const_1142:Number = 25;
      
      private static const const_1226:Number = 90;
      
      private static const const_824:int = 50;
      
      private static const const_1141:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1207:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_526 = new Object();
         this.var_527 = new Array();
         this.var_525 = new Array();
         super();
         this._windowManager = param1;
         this.var_1207 = param2;
         this.var_637 = new Timer(const_1142);
         this.var_637.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_299[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_824 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_824 || param1.desktop.height - param1.y < const_1141;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1207.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_299.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1207.getIconLoc(param1.iconId);
      ...
      {
         return this.var_527[this.var_525.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_525[this.var_527.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_525.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_525.splice(_loc3_,1);
            this.var_527.splice(_loc3_,1);
         }
         this.var_527.push(param1.name);
         this.var_525.push(param2);
         param1.addEventListener(WindowEvent.const_319,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_224,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_526[_loc3_] == null)
            {
               this.var_526[_loc3_] = new Array();
            }
            if(this.var_526[_loc3_].indexOf(param1) < 0)
            {
               this.var_526[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_299.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_299.splice(this.var_299.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_527.length)
         {
            if(this.var_527[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_525[_loc2_];
               if(this.var_526[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_526[_loc3_].length)
                  {
                     this.repositionWindow(this.var_526[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_299.length)
         {
            _loc2_ = this._itemList[this.var_299[_loc7_]];
            if(_loc2_.active)
            {
