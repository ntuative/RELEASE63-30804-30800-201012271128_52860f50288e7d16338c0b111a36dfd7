package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_449:String = "LEFT";
      
      private var var_139:Number = 50;
      
      private var var_1033:Boolean = true;
      
      private var var_1032:Number = 1;
      
      private var var_1274:Number = 0;
      
      private var var_1561:Number = 15;
      
      private var var_1562:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2667 = new Array();
         ...
         this.var_195 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_1004,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1033 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1033)
         {
         ...
         this.var_1032 = _loc6_.toolbar.@margin_top;
         this.var_1274 = _loc6_.toolbar.@margin_bottom;
         this.var_1561 = _loc6_.toolbar.@min_group_margin;
         this.var_1562 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_269 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_230,param1,param2,this._window,this.var_269);
         this.createGroupsFromXmlList(_loc8_,this.var_564,param1,param2,this.var_195,this.var_269);
         this.alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_230.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(this.var_564.length > 0)
         {
            _loc1_ = this.var_564.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_139,this.var_449,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_449);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_139,this.var_449);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_139,this.var_449);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_564.length)
         {
            _loc2_ = this.var_564[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_195.x = this.var_139 + this.var_1562;
               this.var_195.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_195.x = 0;
               this.var_195.y = this.var_139 + this.var_1562;
         ...
         _loc4_ -= this.var_1274;
         _loc4_ -= this.var_1032;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1032;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_230.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1561,(this._window.height - _loc5_ * _loc8_ - this.var_1032 - this.var_1274) / (this.var_230.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1561,(this._window.width - _loc5_ * _loc8_ - this.var_1032 - this.var_1274) / (this.var_230.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_230.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_449;
