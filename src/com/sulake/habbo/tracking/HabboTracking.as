package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_879:uint = 11;
      ...
      private var var_182:IHabboFriendList;
      
      private var var_1129:IHabboWindowManager;
      ...
      private var var_608:FramerateTracker = null;
      
      private var var_245:LatencyTracker = null;
      
      private var var_609:LagWarningLogger = null;
      
      private var var_610:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_608 = new FramerateTracker();
         this.var_245 = new LatencyTracker();
         this.var_609 = new LagWarningLogger();
         this.var_610 = new ToolbarClickTracker(this);
         this.var_1398 = new Array(const_879);
         var _loc4_:int = 0;
         while(_loc4_ < const_879)
         {
            this.var_1398[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1448,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1360,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1506,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_726,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_925,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1129)
            {
               this.var_1129.release(new IIDHabboWindowManager());
               this.var_1129 = null;
            }
            if(this.var_266)
            {
            ...
            if(this._catalog)
            {
               ...
               {
                  this._catalog.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,this.method_3);
                  this._catalog.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,this.method_3);
               }
            ...
            if(this.var_182)
            {
               if(!this.var_182.disposed)
               {
                  Component(this.var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_182).events.removeEventListener(HabboFriendListTrackingEvent.const_323,this.onFriendlistTrackingEvent);
               }
               this.var_182.release(new IIDHabboFriendList());
               this.var_182 = null;
            }
            if(this.var_163)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_245 != null)
            {
               this.var_245.configuration = this._configuration;
            }
            if(this.var_246 != null)
            {
               this.var_246.configuration = this._configuration;
            }
            ...
            if(this._configuration)
            {
               ...
               {
                  this.var_609.configure(this._configuration);
               }
               if(this.var_608 != null)
               {
                  this.var_608.configure(this._configuration);
               }
               if(this.var_610 != null)
               {
                  this.var_610.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_168,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_525,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_245 != null)
            {
               this.var_245.communication = this._communication;
               this.var_245.connection = param1;
            }
            if(this.var_609 != null)
            {
               this.var_609.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_606)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1397);
         }
         else if(param1.type == HabboHotelViewEvent.const_525)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1390);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1440);
               break;
            case HabboCommunicationEvent.const_689:
               this.trackLoginStep(HabboLoginTrackingStep.const_1511,String(this._communication.port));
               break;
      ...
      {
         this.var_1129 = IHabboWindowManager(param2);
         if(this.var_1129)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1398)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1060);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1060,this.onCoreRunning);
         }
      }
      ...
      private function onCatalogReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._catalog.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,this.method_3);
         this._catalog.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,this.method_3);
      }
      ...
      {
         this.var_182 = param2 as IHabboFriendList;
         Component(this.var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_182).events.addEventListener(HabboFriendListTrackingEvent.const_323,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_323:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2526)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1328);
            this.var_2526 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_925,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_726,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_266.events.addEventListener(AdEvent.const_475,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_610)
         {
            this.var_610.track(param1.iconName);
         }
      }
      ...
      {
         this.var_609.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_491 > -1 && _loc2_ < this.var_491)
         {
            ++this.var_1800;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1800);
         }
         if(this.var_491 > -1 && _loc2_ - this.var_491 > 15000)
         {
            ++this.var_1799;
         ...
         if(this.var_246 != null)
         {
            this.var_246.update(param1,this.var_491);
         }
         if(this.var_245 != null)
         {
            this.var_245.update(param1,this.var_491);
         }
         if(this.var_608 != null)
         {
            this.var_608.trackUpdate(param1,this,this.var_491);
         }
         if(this.var_609 != null)
         {
            this.var_609.update(this.var_491);
         }
      }
   }
}
