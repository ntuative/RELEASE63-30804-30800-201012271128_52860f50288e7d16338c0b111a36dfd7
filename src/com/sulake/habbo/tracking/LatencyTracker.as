package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1803 = int(this._configuration.getKey("latencytest.interval"));
         this.var_1802 = int(this._configuration.getKey("latencytest.report.index"));
         this.var_2528 = int(this._configuration.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1801 > this.var_1803)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_611.add(this.var_1399,this.var_1801);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1399));
         ++this.var_1399;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_611 == null || this.var_207 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_611.getValue(_loc2_.requestId);
         this.var_611.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_207.push(_loc4_);
         if(this.var_207.length == this.var_1802 && this.var_1802 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1804) > this.var_2528 || this.var_1804 == 0)
            {
               this.var_1804 = _loc9_;
