package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_262:ChargeConfirmationDialog;
      ...
      private var var_1973:GiftWrappingConfiguration;
      
      private var var_969:ClubGiftController;
      
      private var var_429:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.var_429.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_101.getActivityPointsForType(Purse.const_418)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_746)
         {
            if(!this.var_365.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_256,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1471 = param1.session.isPrivateRoom;
               if(this.var_86 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_969 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_429 == null)
         {
            this.var_429 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_643 && this.var_643 != "")
         {
            this.var_301.openPage(this.var_643);
            this.var_643 = "";
            this.var_787 = -1;
         }
         else if(this.var_787 > -1)
         {
            this.var_301.openPageById(this.var_787,this.var_1472);
            this.var_787 = -1;
            this.var_1472 = -1;
            this.var_643 = "";
         }
      ...
      private function showNotEnoughActivityPointsAlert(param1:int) : void
      {
         ...
         if(param1 == 0)
         {
            this._windowManager.confirm(this.localization.getKey(_loc2_),this.localization.getKey(_loc3_),0,this.method_8);
         }
         else
         {
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_1972 && this.var_533 != null)
         {
            this.var_533.playSound(HabboSoundTypesEnum.const_978);
         }
         this.var_1972 = false;
         if(this.var_262 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_1971 && this.var_533 != null)
         {
            this.var_533.playSound(HabboSoundTypesEnum.const_1031);
         }
         this.var_1971 = false;
         if(this.var_262 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_969.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_1973 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_262 == null)
         {
            this.var_262 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_262.showChargeInfo(_loc2_);
      }
      ...
      private function method_8(param1:IConfirmDialog, param2:Event) : void
      {
         var _loc3_:* = null;
         param1.dispose();
         if(param2.type == WindowEvent.const_189)
