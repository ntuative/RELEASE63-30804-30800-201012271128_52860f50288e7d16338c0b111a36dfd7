package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1252:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1427:XML;
      
      private static var var_1425:XML;
       
      
      private var var_1867:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2694:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1867 == 4294967295)
            {
               this.var_1867 = _loc1_.color;
            }
            _loc1_.color = const_1252;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1456;
            }
         }
      }
      ...
      {
         this.var_52 = navigator.catalog.windowManager.buildFromXML(var_1425) as IItemListWindow;
         if(this.var_52 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1427) as IWindowContainer;
         }
         else
         {
