package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_873:int = 0;
      ...
      {
         return this.var_601 != const_873;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1758 != RecyclerStatusMessageEvent.const_898;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_601 == const_390;
      }
      ...
      {
         this.var_601 = const_874;
         this.var_110 = new Array(const_173);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1758)
         {
            case RecyclerStatusMessageEvent.const_1398:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_898:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1029:
               if(this._view != null)
               {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_110.length < const_173)
         {
            return false;
         }
         var _loc1_:int = 0;
