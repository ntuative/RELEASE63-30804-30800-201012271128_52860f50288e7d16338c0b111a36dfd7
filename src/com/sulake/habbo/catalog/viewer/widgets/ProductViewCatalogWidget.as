package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      {
         this.var_854 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1072 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1663 = new Point(this.var_82.x,this.var_82.y);
         this.var_466 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         ...
         this.var_1662 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_854.text = _loc4_;
         this.var_1072.text = _loc5_;
         this.var_854.height = this.var_854.textHeight + 5;
         this.var_1072.y = this.var_854.y + this.var_854.height;
         this.var_1072.height = Math.max(130,this.var_1072.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_508:
                  _loc6_ = this.var_1662.clone();
                  if(this.var_466 != null)
                  {
                     this.var_466.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_466,this.var_1333,this.var_1458);
                     this.var_466.scrollV = 0;
                  }
                  break;
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_246:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_47);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_42,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_276,AvatarAction.const_514);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2335)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2335 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1663.x;
            this.var_82.y = this.var_1663.y;
            if(param3 != null)
            {
