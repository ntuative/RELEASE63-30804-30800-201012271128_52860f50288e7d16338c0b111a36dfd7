package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1122.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1123 != null)
         {
            this.var_1123.removeEventListener(WindowKeyboardEvent.const_157,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1122 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1122 != null)
         {
            this.var_1122.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1123 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1123 != null)
         {
            this.var_1123.addEventListener(WindowKeyboardEvent.const_157,this.windowKeyEventProcessor);
         }
      }
