package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_539[this.var_988][this.var_1492];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_988 = var_1181.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_988];
         var _loc3_:Array = this.var_539[this.var_988] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1492 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1492] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_440 || _loc1_.pricingModel == Offer.const_460)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_87)
                  {
