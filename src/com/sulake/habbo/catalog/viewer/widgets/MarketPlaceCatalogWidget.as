package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1583:int = 1;
      
      private const const_1584:int = 2;
      
      private const const_1873:int = 40;
      
      private const const_1874:int = 10;
      
      private var var_761:Array;
      
      private var var_1423:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_506)
         {
            this.var_506.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_506 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_623)
         {
            ...
            this.var_623 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_623)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1584,_loc2_.length);
         if(!this.var_506)
         {
            this.var_506 = new Timer(25);
            this.var_506.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1161 = 0;
         this.populateList();
         this.var_506.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1161 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1161));
            ++this.var_1161;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1583);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_102)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1874;
                  break;
               case "search_input":
                  _loc8_ = this.const_1873;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1423.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_59)
