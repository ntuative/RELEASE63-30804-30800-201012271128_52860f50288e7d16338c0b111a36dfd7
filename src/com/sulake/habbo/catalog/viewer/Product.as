package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1767:IProductData;
      ...
      {
         super();
         this.var_1765 = param1.productType;
         this.var_1766 = param1.furniClassId;
         this.var_1385 = param1.extraParam;
         this.var_1386 = param1.productCount;
         this.var_1764 = param1.expiration;
