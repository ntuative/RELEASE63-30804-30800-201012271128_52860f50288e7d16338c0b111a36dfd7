package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1535:String = "ctlg_";
      ...
      private var var_963:ICatalogViewer;
      ...
      private var var_1213:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1214:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1213 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_970);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_970);
      }
      ...
      {
         var _loc2_:String = const_1535 + param1;
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1214 = new ItemGridCatalogWidget(_loc1_);
            this.var_57.push(this.var_1214);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1496) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1310) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new SpecialInfoWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1451) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1405) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1358) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1213;
            _loc2_.init();
         }
         this.var_1213.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1213.dispatchEvent(param1);
      }
   }
}
