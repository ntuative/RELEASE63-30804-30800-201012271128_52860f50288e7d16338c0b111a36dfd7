package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1547:Date;
      
      private var _localizationCode:String;
      
      private var var_174:Boolean = false;
      
      private var var_2126:uint = 2;
      
      private var var_2127:uint = 0;
      
      private var var_826:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1697 = param1.roomItemTypeName;
         this.var_1698 = param1.rewardCurrencyAmount;
         this.var_1547 = new Date();
         this.var_1547.setTime(param1.endDateTimeStamp);
      ...
      private function createView() : void
      {
         switch(this._status)
         {
            case QuestStatusEnum.const_40:
               ...
               break;
            case QuestStatusEnum.const_434:
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_174)
            {
               this.var_826.style = this.var_2127;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_174)
            {
               this.var_826.style = this.var_2126;
            }
         }
      }
