package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_655);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_683);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_693);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_655:
            ...
            case RoomWidgetFriendRequestMessage.const_683:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_693:
