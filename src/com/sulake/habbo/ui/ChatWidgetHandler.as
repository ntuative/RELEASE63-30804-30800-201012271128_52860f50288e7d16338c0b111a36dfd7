package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_711:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_391 != null)
         {
            ...
            {
               _loc2_ = this.var_391.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_604,RoomWidgetChatSelectAvatarMessage.const_780];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_604:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_780:
      ...
      {
         return [RoomSessionChatEvent.const_162];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_162:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_391.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_878.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_216:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_85,this);
                                       if(_loc17_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_85,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_216)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_390.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_391.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_878.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1098 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1098);
            }
            if(this.var_711 == null)
            {
               ...
               this.var_477.y = 0;
               this.var_477.z = 0;
               this.var_711 = _loc4_.getScreenPoint(this.var_477);
               this.var_1098 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_477.x = 0;
            this.var_477.y = 0;
            this.var_477.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_477);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_711.x || _loc8_.y != this.var_711.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_711,_loc5_));
