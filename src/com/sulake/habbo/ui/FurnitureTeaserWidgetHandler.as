package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_625,RoomWidgetViralFurniMessage.const_774,RoomWidgetViralFurniMessage.const_148];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_625:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_403);
                     _loc7_.data = _loc6_;
            ...
            case RoomWidgetViralFurniMessage.const_774:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_148:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_523,RoomSessionViralFurniStatusEvent.const_495];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_523:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_681);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_495:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
