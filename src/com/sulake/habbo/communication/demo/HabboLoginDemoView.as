package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_149.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_130,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1589,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1589,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_126.removeEventListener(SSOTicket.const_348,this.onParsedTicketSuccess);
            this.var_126.removeEventListener(SSOTicket.const_300,this.onParsedTicketFailure);
            this.var_126 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_126.addEventListener(SSOTicket.const_348,this.onParsedTicketSuccess);
         this.var_126.addEventListener(SSOTicket.const_300,this.onParsedTicketFailure);
      }
