package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_496:IKeyExchange;
      
      private var var_914:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2568:PseudoRandom;
      ...
      private var var_209:HabboHotelView;
      
      private var var_1408:String = "";
      
      private const const_1589:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_614 = param1;
            this.var_46.initConnection(HabboConnectionType.const_205);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_93,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_209 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_209.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_614 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1822 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2566 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_209 == null)
         {
            this.var_209 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_46.mode = HabboConnectionType.const_103;
            if(this.var_614)
            {
               this.var_46.initConnection(HabboConnectionType.const_205);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_46.mode = HabboConnectionType.const_998;
            }
         }
         this.var_46.initConnection(HabboConnectionType.const_205);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2568 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_46.mode)
         {
            case HabboConnectionType.const_103:
               _loc6_ = "";
               ...
               this.var_1408 = _loc4_;
               this.var_209.loadBannerImage(_loc7_ + "?token=" + this.var_1408,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_998:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1526:
               this.var_914 = this.generateRandomHexString(30);
               this.var_496 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_496.init(this.var_914);
               _loc8_ = this.var_496.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_496.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_496.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2568);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1822,this.var_2566));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1589,"/");
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_201);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1409)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_168);
         }
         if(param1.type == Event.CLOSE && !this.var_2567)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1408);
         ...
         this.var_496 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_496.init(_loc14_);
            _loc15_ = this.var_496.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_914 = _loc14_;
            }
