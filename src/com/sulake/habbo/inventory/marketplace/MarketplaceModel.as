package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_192 != null)
         {
            this._controller.furniModel.method_2(this.var_192.id);
            this.var_192 = null;
         }
      }
      ...
      {
         if(this.var_192 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_192 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_192.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_192 is FloorItem ? 1 : 2;
         this.var_2227 = _loc2_;
         this.var_2232 = this.var_192.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_192.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_192);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1846,this.var_1845);
         }
      }
      ...
      {
         if(param1 != this.var_2227 || param2 != this.var_2232)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2231);
      }
