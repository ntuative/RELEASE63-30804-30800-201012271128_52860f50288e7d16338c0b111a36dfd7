package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_629:BitmapData;
      
      protected var var_2402:int;
      
      protected var var_1436:Boolean;
      
      protected var var_1913:Boolean;
      
      protected var var_2658:BitmapData;
      
      private const const_1834:int = 8947848;
      
      private const const_1833:int = 13421772;
      
      private const const_1592:Number = 1;
      
      private const const_1593:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2658 = param6;
         this.var_1913 = param7;
         this._items = new Map();
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1390));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_595)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1593;
               _loc1_.blend = this.const_1593;
            }
            else
            {
               this._window.blend = this.const_1592;
               _loc1_.blend = this.const_1592;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1913 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2658;
               _loc5_.visible = true;
            }
            else
            {
