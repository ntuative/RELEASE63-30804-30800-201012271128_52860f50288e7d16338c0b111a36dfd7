package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1486:uint = 9;
      
      public static const const_165:uint = 0;
      
      public static const const_174:uint = 1;
      
      public static const const_381:uint = 2;
      
      public static const const_307:uint = 3;
      
      public static const const_405:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_48.updateItemList(this.var_645);
         this.var_48.updateItemList(this.var_1217);
      ...
      public function close() : void
      {
         if(this.var_688)
         {
            if(this._state != const_165 && this._state != const_231)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_165;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_950);
            this.var_688 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_644 + " OTHER: " + this.var_972);
         ...
         {
            case const_165:
               if(param1 == const_174 || param1 == const_231)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_264.length)
         {
            _loc2_ = this.var_264.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_930);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_645)
            {
               this.var_644 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_972 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_645)
            {
               this.var_48.alertPopup(TradingView.const_1061);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_264.length < const_1486)
         {
         ...
         else
         {
            ...
            if(this.var_264.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
