package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1875:int = 0;
      
      private const const_878:int = 1;
      
      private const const_1557:int = 2;
      
      private const const_1556:int = 3;
      
      private const const_1558:int = 42;
      
      private const const_1559:int = 120;
      ...
      private var var_676:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_433.add(FurniModel.const_41,new FurniGridView(this.var_63,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_433.add(FurniModel.const_45,new FurniGridView(this.var_63,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FurniModel.const_41:
               ...
               this.var_369 = FurniModel.const_41;
               break;
            case FurniModel.const_317:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_369 = FurniModel.const_317;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_433.getValue(this.var_369);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_63.getCategoryContent(this.var_369);
         if(!this.var_63.isListInited())
         {
            _loc2_ = this.const_878;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1557;
         }
         else
         {
            _loc2_ = this.const_1556;
         }
         if(this.var_2012 == _loc2_)
         {
            return;
         }
         this.var_2012 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_878:
               ...
               break;
            case this.const_1557:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1556:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_63.getGroupItemInIndex(_loc3_,this.var_369);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_370)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_676 && this.var_676.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1559)
         {
            _loc3_ = this.const_1559;
         }
         else if(_loc3_ < this.const_1558)
         {
            _loc3_ = this.const_1558;
         }
         else
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "open_catalog_btn":
                  this.var_63.requestCatalogOpen();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_317);
            }
         }
      }
   }
