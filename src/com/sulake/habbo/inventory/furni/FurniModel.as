package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_317:String = "pets";
      
      private static const const_1179:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_576 = new Timer(const_1179,1);
         ...
         this.var_2264 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_175.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_175.stop();
               this.var_175 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_370)
         {
         ...
         if(this.var_846 == null)
         {
            this.var_846 = this._windowManager.buildFromXML(this.var_2264) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_846.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_175 = new Timer(param1,1);
            this.var_175.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_175.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_314);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_456.add(const_41,new Array());
         this.var_456.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_292;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_363 || _loc3_.category == FurniCategory.const_370 || _loc3_.category == FurniCategory.const_318)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1302 && param1.type == RoomEngineObjectEvent.const_209)
         {
            this.var_1302 = false;
         }
      }
      ...
      {
         return this.var_456.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_456.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_456.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_595)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
