package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_450 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_305);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_538.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_450.removeGridItem(_loc2_.window);
         if(this.var_305 == _loc2_)
         {
            this.var_305 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_538 == null || this.var_538.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_538.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_538.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_450.addGridItem(_loc2_.window);
            this.var_538.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_305.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_63.switchCategory(FurniModel.const_41);
                  break;
               case "tab_wall":
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_305 != null)
         {
            this.var_305.setSelected(false);
         }
         this.var_305 = param1;
         if(this.var_305 != null)
         {
            this.var_305.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = this._avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_47,this);
            if(_loc13_ == null)
            {
               return;
            }
