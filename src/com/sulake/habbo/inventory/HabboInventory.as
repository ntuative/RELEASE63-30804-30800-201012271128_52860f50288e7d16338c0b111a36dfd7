package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_993:IRoomSession;
      ...
      private const const_1836:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_93,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_416,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_44.getValue(InventorySubCategory.const_292));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_44.getValue(InventoryCategory.const_754));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_44.getValue(InventoryCategory.const_269));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_44.getValue(InventoryCategory.const_346));
      }
      ...
      {
         return PetsModel(this.var_44.getValue(InventoryCategory.const_149));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_44.getValue(InventoryCategory.const_314) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_93,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_416,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_93:
               this.var_993 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_416:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_365 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_44.add(InventoryCategory.const_314,_loc1_);
         ...
         this.var_44.add(InventoryCategory.const_269,_loc3_);
         ...
         this.var_44.add(InventoryCategory.const_754,_loc4_);
         ...
         this.var_44.add(InventoryCategory.const_346,_loc5_);
         ...
         this.var_44.add(InventorySubCategory.const_292,_loc6_);
         ...
         this.var_44.add(InventoryCategory.const_149,_loc8_);
         this.var_172 = true;
         if(this.var_2202)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_836.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_836.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_836.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_836.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1836);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1084));
      }
