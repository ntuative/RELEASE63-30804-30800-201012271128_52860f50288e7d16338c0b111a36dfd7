package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_828:int = 3;
      ...
      private static const const_856:int = 150;
      
      private static const const_857:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1670 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2344 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1671 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1669 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2341 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2343 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_69 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_273,HabboWindowStyle.const_34,HabboWindowParam.const_58,new Rectangle(0,0,param3.width,param3.height - const_79),null,0,0) as IBitmapWrapperWindow;
         this.var_34.addChild(this.var_69);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_55,HabboWindowStyle.const_34,0 | 0,new Rectangle(0,this.var_34.height - const_79,param3.width,const_79),null,0) as IWindowContainer;
         this.var_34.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_573,HabboWindowStyle.const_37,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_79),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_509:
               this.var_69.blend += param1 / const_857;
               this._window.blend += param1 / const_857;
               ...
               break;
            case const_828:
               this.var_69.blend -= param1 / const_856;
               this._window.blend -= param1 / const_856;
      ...
      public function set state(param1:int) : void
      {
         ...
         switch(param1)
         {
            case const_349:
               ...
               {
                  if(this._window == null || this.var_69 == null)
                  {
                     return;
                  }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_34.width - this.var_2342;
         }
         if(this.var_69 != null)
         {
            this.var_69.rectangle = this.var_34.rectangle;
            this.var_69.height -= const_79;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2340 == this._window.width)
         {
            return;
         }
         this.var_2340 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2344;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1671;
            _loc2_.disposesBitmap = false;
            this.var_2342 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2339,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1670,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1670,_loc9_);
         ...
         this.var_69.bitmap = this.var_2343;
         this.var_69.disposesBitmap = false;
      }
