package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_559:int = 10;
      
      private static const const_851:int = 16;
      
      private static const const_1180:int = 40;
      
      private static const const_1576:int = 5;
      
      private static const const_1181:int = 20;
      ...
      private var var_503:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1054 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2278 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2276 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_324 = new Timer(1000,1);
         this.var_324.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_381 = new Timer(10000,1);
         this.var_381.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_324.reset();
            this.var_324.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         }
         this.var_324 = null;
         if(this.var_381 != null)
         {
            this.var_381.reset();
            this.var_381.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         }
         this.var_381 = null;
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_157,this.windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_44,this.onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_102,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_319,this.onWindowMoved);
         this.var_1629 = true;
         this.var_457 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2277 = _loc2_.width + const_851 + _loc6_.width + const_1181;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1180,_loc8_.width) + const_851);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_503 = param1 - this.var_2277;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_503);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_503);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1054 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_457 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_457.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_457 = _loc2_.text;
            if(!this.var_579)
            {
               this.var_579 = true;
               this.var_324.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_579);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_503)
         {
