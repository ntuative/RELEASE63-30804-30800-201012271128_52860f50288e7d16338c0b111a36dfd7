package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_1293:String = "me_menu_rooms_view";
      
      public static const const_283:String = "me_menu_my_clothes_view";
      
      public static const const_955:String = "me_menu_dance_moves_view";
      
      public static const const_762:String = "me_menu_effects_view";
      
      public static const const_789:String = "me_menu_settings_view";
      
      public static const const_720:String = "me_menu_sound_settings";
      ...
      public function MeMenuWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_2449 = param5.getKey("client.news.embed.enabled","false") == "true";
         }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_761,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_685,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_672,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_364,this.onUpdate);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_596,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_564,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_220,this.onAvatarDeselected);
         param1.addEventListener(RoomWidgetHabboClubUpdateEvent.const_214,this.onHabboClubEvent);
         ...
         param1.addEventListener(RoomWidgetTutorialEvent.const_104,this.onTutorialEvent);
         param1.addEventListener(RoomWidgetTutorialEvent.const_484,this.onTutorialEvent);
         param1.addEventListener(RoomWidgetCreditBalanceUpdateEvent.const_169,this.onCreditBalance);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_103,this.onNormalMode);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_912,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_761,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_685,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_672,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_364,this.onUpdate);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_220,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_214,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarActionUpdateEvent.const_803,this.onAvatarActionEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_596,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_564,this.onAvatarEditorClosed);
         ...
         param1.removeEventListener(RoomWidgetTutorialEvent.const_104,this.onTutorialEvent);
         param1.removeEventListener(RoomWidgetCreditBalanceUpdateEvent.const_169,this.onCreditBalance);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_103,this.onNormalMode);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_103,this.onGameMode);
      }
      
      public function hide(param1:RoomWidgetRoomObjectUpdateEvent = null) : void
      {
         var _loc2_:RoomWidgetToolbarMessage = new RoomWidgetToolbarMessage(RoomWidgetToolbarMessage.const_597);
      ...
      {
         var _loc2_:* = null;
         if(!(this.var_394 && this.var_37.window.name == const_283))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_818);
            if(messageListener != null)
            {
               if(!this.var_1735)
               {
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_37.window.name == const_720)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_484:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_394 + " view: " + this.var_37.window.name);
               if(this.var_394 != true || this.var_37.window.name != const_107)
               {
                  return;
               }
      ...
      private function onUpdateEffects(param1:RoomWidgetUpdateEffectsUpdateEvent) : void
      {
         ...
         if(this.var_37 != null && this.var_37.window.name == const_762)
         {
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1375;
         this.var_1375 = param1.daysLeft;
         this.var_2450 = param1.periodsLeft;
         this.var_2451 = param1.method_10;
         this.var_2452 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_1733);
         this.var_1733 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_37 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetCreditBalanceUpdateEvent) : void
      {
         ...
         this.var_1734 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_1734.toString());
      }
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("me_menu_main_container","",HabboWindowType.const_1363,HabboWindowStyle.const_1004,HabboWindowParam.const_37,new Rectangle(0,0,170,260)) as IWindowContainer;
      ...
      {
         this.var_2331 = new Date().valueOf();
      ...
      public function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2331 > 5000;
      }
