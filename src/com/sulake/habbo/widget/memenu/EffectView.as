package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_937 != null)
         {
            if(this.var_170.isActive)
            {
               ...
               this.var_937.width = _loc2_ * this.var_503;
            }
            else
            {
               this.var_937.width = 0;
               this.var_176.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_936.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_936.text;
            if(this.var_170.isActive)
            {
               ...
               this.var_936.text = _loc1_;
            }
            else
            {
               this.var_936.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_938 = this._window.findChildByName("effect_hilite");
            this.var_938.visible = false;
         }
         this.var_936 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_937 = this._window.findChildByName("loader_bar");
         if(this.var_937 != null)
         {
            this.var_503 = this.var_937.width;
            this.var_176.start();
            this.onUpdate();
         }
