package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1830:int = 5;
      
      private const const_1829:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_141:Function;
      
      private var _offsetX:int;
      
      private var var_986:int;
      
      private var var_987:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_986 = 0;
         this.var_987 = param2.rectangle.clone();
         this.var_987.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_987.width)
         {
            return false;
         }
         if(this.var_986 + param1.height > this.var_987.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_987.width)
         {
            this._offsetX = 0;
            this.var_986 += param1.height + this.const_1829;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_986);
         this._offsetX += param1.width + this.const_1830;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1225 != null && this.var_1225.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_141);
