package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1606 = param1.id;
         this._type = param1.petType;
         this.var_2245 = param1.petRace;
         this.var_38 = param1.image;
         this.var_2221 = param1.isOwnPet;
         this.var_2088 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1277 = param1.level;
         this.var_2091 = param1.levelMax;
         this.var_2092 = param1.experience;
         this.var_2086 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2090 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2087 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2222 = param1.roomIndex;
         this.var_479 = param1.age;
      }
   }
}
