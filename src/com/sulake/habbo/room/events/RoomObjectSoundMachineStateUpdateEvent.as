package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_599:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
      
      public static const const_598:String = "ROSM_JUKEBOX_INIT";
      
      public static const const_533:String = "ROSM_DISPOSE";
