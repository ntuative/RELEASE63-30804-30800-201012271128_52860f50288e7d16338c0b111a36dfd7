package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1388:int = 13421772;
      
      private static const const_887:int = 16777215;
      
      private static const const_888:int = 13421772;
      
      private static const const_889:int = 10066329;
      
      private static const const_890:int = 10066329;
      
      public static const const_1386:int = 16777215;
      
      public static const const_1482:int = 13421772;
      ...
      private var var_758:Rectangle = null;
      
      private var var_505:RoomPlaneBitmapMaskParser = null;
      
      private var var_1456:String = null;
      
      private var _floorType:String = null;
      
      private var var_1453:String = null;
      
      private var var_2605:String = null;
      
      private var var_1158:uint = 16777215;
      
      private var var_2604:int = 255;
      
      private var var_2603:int = 255;
      ...
      private const const_1872:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_505 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_758 = super.boundingRectangle;
         }
         return new Rectangle(this.var_758.x,this.var_758.y,this.var_758.width,this.var_758.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_970);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_150)
            {
               ...
               {
                  _loc13_.color = const_890;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_887;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_888;
               }
               else
               {
                  _loc13_.color = const_889;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1335)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_105,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1872 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_620[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_349[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_90)
               {
                  if(this.var_1850)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2602 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2603 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2604 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1589)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1344 || _loc3_.y != this.var_2371 || _loc3_.z != this.var_2367 || param1.scale != this.var_2370))
            {
               this.var_1344 = _loc3_.x;
               this.var_2371 = _loc3_.y;
               this.var_2367 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_968);
            if(_loc3_ != this.var_2605)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2605 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_778));
            if(_loc4_ != this.var_1158)
            {
               this.var_1158 = _loc4_;
               this.var_2602 = this.var_1158 & 255;
               this.var_2603 = this.var_1158 >> 8 & 255;
               this.var_2604 = this.var_1158 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1122));
            if(_loc5_ != this.var_1850)
            {
               this.var_1850 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_218 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_640);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_748);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_623);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_721));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_727));
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_505.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_505.maskCount)
         {
            _loc10_ = this.var_505.getMaskType(_loc8_);
            _loc11_ = this.var_505.getMaskLocation(_loc8_);
            _loc12_ = this.var_505.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_127.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_90)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_90 && _loc12_ == RoomPlaneBitmapMaskData.const_199)
                              {
