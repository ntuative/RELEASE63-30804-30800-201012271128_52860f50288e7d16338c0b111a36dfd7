package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_228:IRoomObjectSprite;
      ...
      private var var_1027:Number = 1.0;
      
      private var var_561:BitmapData;
      
      private var var_669:ColorTransform;
      
      private var var_1268:ColorTransform;
      
      private var var_1550:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_652:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_669 = new ColorTransform();
         this.var_669.alphaMultiplier = 1;
         this.var_1268 = new ColorTransform();
         this.var_1550 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_96 = this.var_1028[param1];
         this.var_829 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1551 >= 0)
         {
            this.var_228 = this._visualization.getSprite(this.var_1551);
            if(this.var_228 && this.var_228.asset)
            {
               if(this.var_228.width <= 1 || this.var_228.height <= 1)
               {
                  return;
               }
               if(this.var_81 == null)
               {
                  this.var_81 = this.var_228.asset.clone();
                  if(this.var_669.alphaMultiplier != 1)
                  {
                     this.var_561 = new BitmapData(this.var_81.width,this.var_81.height,true,4278190080);
                  }
               }
               this.var_2122 = -this.var_228.offsetX;
               this.var_2121 = -this.var_228.offsetY;
               this.var_228.asset = this.var_81;
            }
            if(this.var_81)
            {
            ...
            if(this.var_561)
            {
               this.var_561.fillRect(this.var_561.rect,4278190080);
            }
         }
      }
      ...
      {
         if(this.var_96 && this.var_96.roomObjectSpriteId == param1)
         {
            return this.var_96.y * this.var_1027;
         }
         return 0;
      }
      ...
      {
         if(!this.var_96 || !this.var_228)
         {
            return;
         }
         if(this.var_81 && this.var_228.asset != this.var_81)
         {
            this.var_228.asset = this.var_81;
         }
         if(this.var_829)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_829 && this.var_96.hasIgnited)
         {
            this.var_829 = true;
         }
         _loc8_ = this.var_986 * this.var_1027;
         this.var_96.update();
         if(this.var_829)
         {
            if(this.var_96.roomObjectSpriteId >= 0)
            ...
            {
               this.var_81.draw(this.var_561,this.var_1550,this.var_669,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_96.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2122 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1027;
               _loc4_ = this.var_2121 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1027;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1268.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_81.draw(_loc7_,this._translationMatrix,this.var_1268,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2156 = parseInt(param1.@size);
         this.var_1551 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_986 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1027 = this.var_2156 / 64;
         this.var_652 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_652 = Math.min(this.var_652,1);
         this.var_669.alphaMultiplier = this.var_652;
