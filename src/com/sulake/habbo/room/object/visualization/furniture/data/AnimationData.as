package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      {
         var _loc3_:AnimationLayerData = this.var_106.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:AnimationLayerData = this.var_106.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
