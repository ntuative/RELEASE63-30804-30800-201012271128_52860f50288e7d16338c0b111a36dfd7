package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_315,"");
         _loc2_.setString(RoomObjectVariableEnum.const_694,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_412,Number(false));
         this.var_746 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1377 > 0 && param1 > this.var_1377)
         {
            this.adDelayTimeout();
            this.var_1377 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_948:
                  _loc2_.setString(RoomObjectVariableEnum.const_315,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_694,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_412,Number(true));
                  this.var_1377 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1080);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_412,Number(false));
      }
