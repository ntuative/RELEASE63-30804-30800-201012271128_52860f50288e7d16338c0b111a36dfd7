package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1440:int = 255;
      
      private var var_1424:uint = 16777215;
      
      private var var_1862:int = 255;
      
      private var var_1162:uint = 16777215;
      
      private var var_1863:int = 255;
      
      private var var_1163:int = 0;
      
      private var var_1861:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_778,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_721,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_727,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1163)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1440;
            if(_loc2_ - this.var_1163 >= this.var_1861)
            {
               _loc3_ = this.var_1162;
               _loc4_ = this.var_1863;
               this.var_1163 = 0;
            }
            else
            {
               _loc7_ = this.var_1424 >> 16 & 255;
               _loc8_ = this.var_1424 >> 8 & 255;
               _loc9_ = this.var_1424 & 255;
               _loc10_ = this.var_1162 >> 16 & 255;
               _loc11_ = this.var_1162 >> 8 & 255;
               _loc12_ = this.var_1162 & 255;
               _loc13_ = (_loc2_ - this.var_1163) / this.var_1861;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1862 + (this.var_1863 - this.var_1862) * _loc13_;
               this._color = _loc3_;
               this.var_1440 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_778,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_751:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_809:
               param2.setString(RoomObjectVariableEnum.const_640,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_629:
               param2.setString(RoomObjectVariableEnum.const_623,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_541:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_199)
               {
                  _loc5_ = "null";
               }
               this.var_505.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_781:
               _loc4_ = this.var_505.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_505.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_968,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1100:
               param2.setNumber(RoomObjectVariableEnum.const_721,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_954:
               param2.setNumber(RoomObjectVariableEnum.const_727,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1122,int(param1.bgOnly));
         this.var_1424 = this._color;
         this.var_1862 = this.var_1440;
         this.var_1162 = _loc3_;
         this.var_1863 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_485,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1381,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1425,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1419,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_485,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_150 || _loc13_ == RoomPlaneData.const_297)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
