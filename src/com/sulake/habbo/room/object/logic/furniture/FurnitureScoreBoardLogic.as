package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_846:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_684 != _loc2_)
         {
            _loc3_ = this.var_684 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_389 > const_846)
            {
               this.var_1048 = const_846 / _loc3_;
            }
            else
            {
               this.var_1048 = const_389;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_684 && param1 >= this.var_1298 + this.var_1048)
            {
               _loc3_ = param1 - this.var_1298;
               _loc4_ = _loc3_ / this.var_1048;
               _loc5_ = 1;
               if(this.var_684 < _loc2_)
               {
                  _loc5_ = -1;
               }
               if(_loc4_ > _loc5_ * (this.var_684 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_684 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1298 = param1 - (_loc3_ - _loc4_ * this.var_1048);
            }
         }
      }
   }
