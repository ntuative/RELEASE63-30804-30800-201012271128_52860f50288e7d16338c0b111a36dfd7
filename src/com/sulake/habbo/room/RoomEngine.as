package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_546:String = "temporary_room";
      
      private static const const_310:int = -1;
      
      private static const const_545:String = "room";
      
      private static const const_832:int = -2;
      
      private static const const_1158:String = "tile_cursor";
      
      private static const const_831:int = -3;
      
      private static const const_1159:String = "selection_arrow";
      
      private static const const_830:String = "overlay";
      ...
      private var var_809:IRoomRendererFactory = null;
      ...
      private var var_655:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_655 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_40 != null)
         {
            this.var_40.release(new IIDRoomManager());
            this.var_40 = null;
         }
         if(this.var_809 != null)
         {
            this.var_809.release(new IIDRoomRendererFactory());
            this.var_809 = null;
         }
         ...
         if(this.var_310 != null)
         {
            ...
            {
               _loc2_ = this.var_310.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_310.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_310.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         if(this.var_40 != null)
         {
            this.var_40.update(param1);
         }
         this.updateRoomCameras(param1);
         var _loc2_:IRoomInstance = this.var_40.getRoom(this.getRoomIdentifier(this.var_93,this.var_94));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_310.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_93 || _loc6_ != this.var_94 || !this.var_1006)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_576) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_605) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_575) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_695) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_451;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_40 = param2 as IRoomManager;
         if(this.var_40 != null)
         {
            this.var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
            this.var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_27);
            this.var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_USER);
            this.var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_305);
            this.var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_75);
            this.var_40.setContentLoader(this.var_14);
         }
         this.initializeRoomManager();
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_809 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_708,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_708)
         {
            this.var_2080 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_266.events.addEventListener(AdEvent.const_475,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_14.sessionDataManager = this.var_365;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_23 != null)
         {
            ...
            {
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_257,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_461,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_500,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_118,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_653,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_137,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_123,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_135,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_539,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_507,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_474,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_470,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_496,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_517,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_60,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_537,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_465,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_281,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_419,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_344,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_335,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_422,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_1025,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_491,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_23 == null || this.var_451 == null || this.var_40 == null || this.var_809 == null || this._communication == null || this._habboConfiguration == null || !this.var_2080)
         {
            return;
         }
         this.var_40.initialize(<nothing/>,this);
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_438 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_668,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_309.length)
            {
               _loc3_ = this.var_309.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_904,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_904);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function getRoom(param1:int, param2:int) : IRoomInstance
      {
         ...
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         return this.var_40.getRoom(_loc3_);
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_438)
         {
            _loc5_ = this.var_309.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_309.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_782,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = this.var_40.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_996,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_594,1,true);
            _loc13_ = parseInt(this._habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1080,_loc13_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_310,const_545,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_594,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_579,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_576,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_575,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_605,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_970,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_751,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_809,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_629,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_541,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_199);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_675,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_644,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_675,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_644,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1120,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1106,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_832,const_1158,RoomObjectCategoryEnum.const_305);
         _loc7_.createRoomObject(const_831,const_1159,RoomObjectCategoryEnum.const_305);
         return _loc7_;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_309.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_309.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_751,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_809,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_629,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1408,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_954,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1100,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         this.var_40.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = this.var_310.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = this.var_40.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_809.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1109;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_579);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_675);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_644);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1120);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1106);
      ...
      {
         var _loc4_:String = this.getRoomIdentifier(param1,param2);
         var _loc5_:IRoomInstance = this.var_40.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      {
         var _loc8_:int = param2 - this.var_1242;
         var _loc9_:int = param3 - this.var_1243;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1006 = true;
               this.var_810 = false;
               this.var_2079 = this.var_1242;
               this.var_2081 = this.var_1243;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1006)
            {
               if(!this.var_810)
               {
                  _loc8_ = param2 - this.var_2079;
                  _loc9_ = param3 - this.var_2081;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_425,this.var_93,this.var_94,-1,RoomObjectCategoryEnum.const_144));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_67 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_310,const_545);
                     this.var_67.handleRoomObjectEvent(_loc14_,this.var_93,this.var_94);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_830) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1244);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1242 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1243 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1244);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1244);
         if(_loc1_ != null)
         {
      ...
      public function getRoomObject(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = this.var_40.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_67 != null)
         {
            return this.var_67.modifyRoomObject(this.var_93,this.var_94,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_67 != null)
         {
            ...
            {
               return this.var_67.modifyWallItemData(this.var_93,this.var_94,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_67.deleteWallItem(this.var_93,this.var_94,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_594) != 0)
         {
            return false;
         }
         if(this.var_67 != null)
         {
            return this.var_67.initializeRoomObjectInsert(this.var_93,this.var_94,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_67 != null)
         {
            this.var_67.cancelRoomObjectInsert(this.var_93,this.var_94);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_831,RoomObjectCategoryEnum.const_305);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_832,RoomObjectCategoryEnum.const_305);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_251,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_337,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_369,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_940,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1088,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_967,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_261,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_251,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_337,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_369,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1109,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_261,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1028) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_989);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_541,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_781,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_261,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_372);
         }
      ...
      {
         var _loc5_:IRoomInstance = this.var_40.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:IRoomInstance = this.var_40.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_749,this.var_93,this.var_94,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_67 != null)
         {
            this.var_67.handleRoomObjectEvent(param1,this.var_93,this.var_94);
         }
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = this.var_40.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_251));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = this.var_40.getRoom(const_546);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_40.createRoom(const_546,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_655.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_251,int(param2));
            ...
            case RoomObjectCategoryEnum.const_75:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_297,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_748,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_640,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_623,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_541,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            this.var_1005.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_959,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_655.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.var_40.isContentAvailable(param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_40.getRoom(const_546);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_959);
               ...
               this.var_655.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1005.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_89);
            if(_loc7_ != null)
            {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_315,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_938,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_980,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_948,RoomObjectVariableEnum.const_315,param1.clickUrl);
