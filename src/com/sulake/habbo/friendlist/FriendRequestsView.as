package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1577:String = "no_reqs_info";
      ...
      private var var_1640:IContainerButtonWindow;
      
      private var var_1641:IContainerButtonWindow;
      ...
      {
         this.var_1640 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1641 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1641.procedure = this.onDismissAllButtonClick;
         this.var_1640.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_379;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_373;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_266,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_379 && _loc4_.state != FriendRequest.const_373)
            {
               _loc4_.state = FriendRequest.const_373;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_266,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_379 && _loc4_.state != FriendRequest.const_373)
            {
               ...
               _loc4_.state = FriendRequest.const_379;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1640,_loc1_);
         this.setEnabled(this.var_1641,_loc1_);
      }
