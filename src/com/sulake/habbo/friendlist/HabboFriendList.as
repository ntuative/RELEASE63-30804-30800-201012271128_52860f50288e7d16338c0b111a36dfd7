package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_120:IHabboMessenger;
      
      private var _configuration:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_968:IAvatarRenderManager;
      
      private var var_760:ISessionDataManager;
      
      private var var_2607:FriendListLookAndFeel;
      
      private var var_409:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1855:OpenedToWebPopup;
      ...
      private var var_1854:AvatarSearchResults;
      ...
      {
         this.var_2607 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_92 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1854 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_621.stop();
            this.var_621.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_621 = null;
         }
         ...
         if(this.var_120)
         {
            this.var_120.release(new IIDHabboMessenger());
            this.var_120 = null;
         }
         ...
         if(this.var_968)
         {
            this.var_968.release(new IIDAvatarRenderManager());
            this.var_968 = null;
         }
         if(this.var_887)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1855 = new OpenedToWebPopup(this);
         }
         this.var_1855.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_350.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:IAvatarImage = this.var_968.createAvatarImage(param1,AvatarScaleType.const_85,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_120 = param2 as IHabboMessenger;
      ...
      {
         this.var_887 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_350 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_947,this.getText("friendlist.friends")));
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_324,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_621)
         {
            this.var_621 = new Timer(120000);
            this.var_621.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_621.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_92.findCategory(FriendCategory.const_324);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_323));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_350.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_350.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_409.findTab(FriendListTab.const_94).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_350.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_409.findTab(FriendListTab.const_94);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1854.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_409.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_760 || !this.var_350)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_760.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_350.vipLimit;
         }
         else if(this.var_760.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_350.clubLimit;
         }
         if(_loc2_ > this.var_350.limit)
         {
            this.var_350.limit = _loc2_;
         }
      }
