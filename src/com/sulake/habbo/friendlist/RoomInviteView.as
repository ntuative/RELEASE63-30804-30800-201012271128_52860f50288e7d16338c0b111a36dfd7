package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_174 = param1.categories.getSelectedFriends();
      }
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_174.length);
         this.var_849 = ITextFieldWindow(param1.findChildByName("message_input"));
