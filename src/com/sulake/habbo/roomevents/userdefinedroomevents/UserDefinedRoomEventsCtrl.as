package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1841:TriggerConfs;
      
      private var var_1842:ActionTypes;
      
      private var var_1840:ConditionTypes;
      ...
      private var var_1147:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1841 = new TriggerConfs();
         this.var_1842 = new ActionTypes();
         this.var_1840 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.find(this.var_90,"helplink").mouseTreshold = 0;
         this.find(this.var_90,"apply_snapshot_txt").mouseTreshold = 0;
         this.var_1147 = new SliderWindowController(this.var_89,IWindowContainer(this.find(this.var_90,"delay_slider_container")),this.var_89.assets,0,20,1);
         this.var_1147.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1147.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_755.hideAll(this.var_254);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_755.showAll(this.var_254);
         if(this.var_58 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_58);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1147.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1147.getValue()) : 0;
      }
