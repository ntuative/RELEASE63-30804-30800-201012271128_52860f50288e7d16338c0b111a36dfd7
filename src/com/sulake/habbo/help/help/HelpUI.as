package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1565:int = 0;
      ...
      private var var_314:IWindowContainer;
      ...
      {
         this.var_313 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012271035));
         this._toolbar = param5;
         this.var_95 = new Map();
         this.var_95.add(HabboHelpViewEnum.const_1387,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_161,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_404,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_304,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_247,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_660,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_371,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_756,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_237,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_95.add(HabboHelpViewEnum.const_1105,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_95.add(HabboHelpViewEnum.const_966,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_602,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_440.length == 0 || param1 != this.var_313)
            {
               this.var_440.push(this.var_313);
            }
         }
         this.var_313 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_313);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_237:
               this.showUI(HabboHelpViewEnum.const_237);
               break;
            case CallForHelpResultEnum.const_1023:
               this.showUI(HabboHelpViewEnum.const_966);
               break;
            case CallForHelpResultEnum.const_1059:
               this.showUI(HabboHelpViewEnum.const_1105);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_95.getValue(HabboHelpViewEnum.const_161) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_518));
      }
      ...
      {
         return this.var_95.getValue(this.var_313);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1528 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1527;
         this._window.width = _loc1_.width + this.var_1528;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_440.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_313 == HabboHelpViewEnum.const_161)
         {
            return;
         }
         if(this.var_554.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_554.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_554.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_314.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_554[1],this.var_554[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_554[0],this.var_554[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_313 == HabboHelpViewEnum.const_161 || this.var_440.length == 0)
         {
            return;
         }
         if(this.var_314 == null)
         {
            ...
            this.var_314 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_314.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_314.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_314 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_314 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_314 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
