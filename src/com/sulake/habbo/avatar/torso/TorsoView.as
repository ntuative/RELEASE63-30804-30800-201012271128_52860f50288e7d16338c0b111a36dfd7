   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_250,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_179,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_254,_windowManager,_assetLibrary);
         }
         else
         {
