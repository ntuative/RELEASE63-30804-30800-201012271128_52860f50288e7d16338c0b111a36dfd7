   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_249,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_229,_windowManager,_assetLibrary);
         }
         else
         {
