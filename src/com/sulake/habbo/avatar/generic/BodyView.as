package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_553:String = "tab_boy";
      
      private const const_554:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
