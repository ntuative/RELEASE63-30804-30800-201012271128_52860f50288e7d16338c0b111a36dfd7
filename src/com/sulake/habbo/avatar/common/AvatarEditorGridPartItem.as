package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_751:IFigurePartSet;
      ...
      private var var_616:Rectangle;
      
      private var var_1829:int = 0;
      
      private var var_410:IAvatarRenderManager;
      
      private var var_677:Boolean;
      
      private var var_1828:BitmapData;
      
      private const const_1834:int = 13421772;
      
      private const const_1833:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_629 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1829 = Math.max(this.var_1829,_loc6_.colorLayerIndex);
            }
         }
         this.var_410 = this.var_63.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_629 != null && !this.var_1827)
            {
               _loc3_ = this.var_629;
            }
            else
            ...
            if(this.var_751)
            {
               switch(this.var_751.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_52:
                     _loc2_.style = HabboIconType.const_650;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this._window.color = this.const_1834;
         }
         else
         {
            this._window.color = this.const_1833;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = this.var_410.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_410.isFigureReady(_loc1_))
         {
            this.var_410.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               ...
               _loc4_ = this.var_410.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_616 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1828)
               {
                  ...
                  this.var_1828 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_616.width,this.var_616.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_616.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_616.y;
               if(this.var_1827 && _loc2_.colorLayerIndex > 0)
               {
