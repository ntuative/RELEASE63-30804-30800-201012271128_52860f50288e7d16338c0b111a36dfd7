package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_194 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_830 >= 0 && this._parts.length > this.var_830)
         {
            _loc2_ = this._parts[this.var_830];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_194[param2],param2);
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_194 || this.var_194.length == 0)
         {
            return null;
         }
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_194.length)
         {
            _loc7_ = this.var_229[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_194[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_194[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_194[param1])
         {
            return null;
         }
         return _loc2_[this.var_194[param1]] as AvatarEditorGridColorItem;
      }
      ...
      {
         return this._parts[this.var_830] as AvatarEditorGridPartItem;
      }
      ...
      public function method_13(param1:int) : Boolean
      {
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc8_:* = null;
