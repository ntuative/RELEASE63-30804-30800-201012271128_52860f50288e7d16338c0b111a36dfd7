package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_899:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_724.width,this.var_724.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_724,this.var_724.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1116.width,this.var_1116.height,true,0);
            _loc5_ = this.var_1116.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_899.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_898.width,this.var_898.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_898,this.var_898.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_899)
            {
               switch(this.var_899.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_52:
                     _loc4_.style = HabboIconType.const_650;
                     _loc4_.visible = true;
               }
            }
            else
