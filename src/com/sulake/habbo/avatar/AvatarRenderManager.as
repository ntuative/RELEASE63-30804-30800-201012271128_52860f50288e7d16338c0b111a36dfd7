package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1854:String = "hd-99999-99999";
      ...
      private var var_328:PetDataManager;
      
      private var var_693:PaletteManager;
      
      private var var_556:String;
      
      private var var_274:Map;
      
      private var var_198:AvatarAssetDownloadManager;
      
      private var var_1655:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_556 = RenderMode.const_1525;
         this.var_274 = new Map();
         this.var_97 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_109,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_97.add(AvatarType.const_109,_loc4_);
         ...
         this.var_97.add(AvatarType.const_66,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_328 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_693 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_328.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_198)
         {
            this.var_198.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_328.init();
         this.var_693.init();
         _loc2_ = this.var_97.getValue(AvatarType.const_109) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_97.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_97.getValue(AvatarType.const_109) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_198 == null)
               {
                  ...
                  this.var_198 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_198.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_890)
         {
            if(this.var_2328 && this.var_2326 && this.var_2327)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_198.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_198.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_97.getValue(AvatarType.const_109) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_198.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1655)
         {
            this.var_1655 = new AvatarFigureContainer(this.const_1854);
         }
         this.var_198.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1655,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_274.getKeys())
         {
            _loc4_ = this.var_274.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1514)
         {
            _loc6_ = !this.var_328.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_328.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_97.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_274.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_328.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_97.getValue(AvatarType.const_66);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_274.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_274.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_97.getValue(AvatarType.const_109) as AvatarStructure;
      ...
      {
         return this.var_328 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_109:
               _loc3_ = this.var_97.getValue(AvatarType.const_109) as AvatarStructure;
               break;
            case AvatarType.const_66:
               _loc3_ = this.var_97.getValue(AvatarType.const_66) as AvatarStructure;
               break;
            default:
