package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1146:String = "Default";
      
      private static const const_1145:int = 2;
      
      private static const const_1147:String = AvatarSetType.const_32;
      ...
      protected var var_535:AvatarFigureContainer;
      
      protected var var_510:IAvatarDataContainer;
      
      protected var var_291:Array;
      
      protected var var_38:BitmapData;
      ...
      private var var_1964:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1147,const_1145);
         this.var_291 = new Array();
         this.var_869 = new ActiveActionData(AvatarAction.const_339);
         this.var_869.definition = this._structure.getActionDefinition(const_1146);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_535,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1466;
         if(param2 < AvatarDirectionAngle.const_994)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_529,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_261.length == 1 && this.var_85 == this.var_1894)
         {
            return this.var_85 + this.var_428 + this.var_529 % 4;
         }
         if(this.var_261.length == 2)
         {
            for each(_loc1_ in this.var_261)
            {
               ...
               {
                  return this.var_85 + this.var_428 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_529 % 11;
                  return this.var_85 + "_" + this.var_1894 + this.var_428 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_1965 || param2 != this.var_1964 || param1 != this.var_1966)
         {
            this.var_1965 = param3;
            this.var_1964 = param2;
            this.var_1966 = param1;
            this.var_1467 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(_loc3_ != null)
         {
            if(this.getFullImage(_loc3_))
            {
               ...
               this.var_38 = this.getFullImage(_loc3_) as BitmapData;
               this.var_1173 = true;
               return this.var_38;
            }
         }
         ...
         if(this.var_1173 || this.var_38 == null || (this.var_38.width != _loc5_.width || this.var_38.height != _loc5_.height))
         {
            if(this.var_38 != null && !this.var_1173)
            {
               this.var_38.dispose();
            }
            this.var_38 = new BitmapData(_loc5_.width,_loc5_.height,true,16777215);
            this.var_1173 = false;
         }
         var _loc6_:Array = this.getBodyParts(param1,this.var_256.definition.geometryType,this.var_85);
         this.var_38.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_529);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               _loc10_ = _loc9_.image;
               _loc11_ = _loc9_.regPoint.clone();
               this.var_38.copyPixels(_loc10_,_loc10_.rect,_loc11_.add(_loc7_),null,null,true);
            }
            _loc12_--;
         }
         this.var_38.unlock();
         ...
         {
            if(this.var_510.paletteIsGrayscale)
            {
               _loc13_ = this.convertToGrayscale(this.var_38);
               if(this.var_38)
               {
                  this.var_38.dispose();
               }
               this.var_38 = _loc13_;
               this.var_38.paletteMap(this.var_38,this.var_38.rect,new Point(0,0),this.var_510.reds,[],[]);
            }
            else
            {
         ...
         if(_loc3_ != null)
         {
            this.cacheFullImage(_loc3_,this.var_38.clone());
         }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_256.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_529);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_291.push(new ActiveActionData(param1,param2,this.var_529));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_256 = this.var_869;
         this.var_256.definition = this.var_869.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_428 = "";
         this.var_261 = this._structure.sortActions(this.var_291);
         if(this.var_261 == null)
         {
            this.var_691 = new Array(0,0,0);
            if(this.var_1211 != "")
            {
               _loc1_ = true;
               this.var_1211 = "";
         ...
         {
            this.var_691 = this._structure.getCanvasOffsets(this.var_261,this._scale,this.var_85);
            for each(_loc4_ in this.var_261)
            {
               ...
               if(_loc4_.actionType == AvatarAction.const_285)
               {
                  ...
                  if(this.var_1209 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1209 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1211 != this.var_428)
            {
               _loc1_ = true;
               this.var_1211 = this.var_428;
            }
         }
         this.var_1210 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1466 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_510 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_264 || _loc1_.actionType == AvatarAction.const_248 || _loc1_.actionType == AvatarAction.const_341)
               {
                  this.var_868 = true;
               }
            }
