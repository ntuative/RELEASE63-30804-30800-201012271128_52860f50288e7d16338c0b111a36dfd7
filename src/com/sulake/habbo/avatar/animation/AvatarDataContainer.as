package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1504:Number = 1.0;
      
      private var var_1502:Number = 1.0;
      
      private var var_1503:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2534 = parseInt(_loc2_,16);
         this.var_2535 = parseInt(_loc3_,16);
         ...
         this.var_1714 = new ColorTransform(this.var_1504,this.var_1502,this.var_1503,this._alphaMultiplier);
         this.var_1131 = this.generatePaletteMapForGrayscale(this.var_2535,this.var_2534);
      }
      ...
      {
         return this.var_1131.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1131.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1131.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1131.getValue("alphas") as Array;
      }
