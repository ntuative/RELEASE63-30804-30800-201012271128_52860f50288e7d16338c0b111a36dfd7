package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         {
            this.var_366 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_366 && this.var_1053)
         {
            this.var_366.bitmap = new BitmapData(this.var_366.width,this.var_366.height,true,16777215);
            this.var_366.bitmap.copyPixels(this.var_1053,this.var_1053.rect,new Point(0,this.var_366.height - this.var_1053.height - 8));
            this.var_366.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
