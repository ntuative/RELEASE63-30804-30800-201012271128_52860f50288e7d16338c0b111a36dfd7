package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1169:IWindowContainer;
      
      public static var var_1428:IWindowContainer;
      
      public static var var_1879:int = 6710886;
      ...
      private var var_464:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1070 = [];
         this.var_1332 = [AvatarEditorFigureCategory.const_665,AvatarEditorFigureCategory.const_42,AvatarEditorFigureCategory.const_215,AvatarEditorFigureCategory.const_700,AvatarEditorFigureCategory.const_1082,AvatarEditorFigureCategory.const_95];
         super();
         ...
         if(var_1169 == null)
         {
            ...
            var_1169 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1428 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1428 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_384 = new Timer(1000);
         this.var_384.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1332;
         }
         for each(_loc6_ in param4)
         {
            this.var_1070.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1332);
         }
         if(param1.length != this.var_1070.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1070.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2332 = this.canChangeOutfit();
            this.var_384.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_464 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_464.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_464.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1070.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_464.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_464.numSelectables)
               {
                  this.var_464.getSelectableAt(_loc6_).x = this.var_464.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1332;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1658 == AvatarEditorSideCategory.const_95 || this.var_2330))
         {
         ...
         this.setViewToCategory(this.var_313);
      }
      ...
      {
         if(this.var_1658 == AvatarEditorSideCategory.const_95)
         {
            this.var_2330 = false;
            this.setSideContent(AvatarEditorSideCategory.const_673);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_673:
               break;
            case AvatarEditorSideCategory.const_397:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_397);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_313 = param1;
         this.var_464.setSelected(this.var_464.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_463)
         {
            ...
            this.var_463 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_463.procedure = this.stripClubDialogEventProc;
            this.var_463.center();
         }
         else
         {
