package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_143:AvatarRenderManager;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1264.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_558.getValue(_loc6_) == null)
               {
                  ...
                  this.var_558.add(_loc6_,_loc8_);
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_558.getKeys())
         {
            _loc5_ = this.var_558.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
