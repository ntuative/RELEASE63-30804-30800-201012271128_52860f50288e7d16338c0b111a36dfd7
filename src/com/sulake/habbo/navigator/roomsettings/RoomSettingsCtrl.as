package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_364:IRoomSettingsCtrlOwner;
      ...
      private var var_646:TextFieldManager;
      ...
      private var var_974:ICheckBoxWindow;
      
      private var var_978:ICheckBoxWindow;
      
      private var var_980:ICheckBoxWindow;
      
      private var var_537:ICheckBoxWindow;
      ...
      private var var_1478:IWindowContainer;
      ...
      {
         this.var_303 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_303));
         if(this.var_981 != null)
         {
            this.var_981.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_303)
         {
            return;
         }
         this.var_72 = param1;
         this._active = true;
         this.var_1480 = true;
         this.var_364.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_303)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_303 || this.var_977 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_977 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1290)
         {
            this.var_646.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1439)
         {
            this.var_646.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1311)
         {
            this.var_979.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1389)
         {
            this.setTagError(this.var_793,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_795,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1436)
         {
            this.setTagError(this.var_793,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_795,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1308)
         {
            this.var_794.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_646.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_646 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_979 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_793 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_795 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_794 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_975 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_974 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_978 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_980 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_537 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1479 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1218 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_982 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_976 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1478 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1219 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_222 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_981 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1991 = ITextWindow(this._window.findChildByName("basic_caption"));
         ...
         this.var_1481.procedure = this.onSwitchView;
         this.var_981.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1479.visible = this._inRoom;
         this.var_1478.visible = this._inRoom;
         this.var_1992.visible = this.var_430;
         this.var_1991.visible = !this.var_430;
         if(this.var_430)
         {
            this.var_976.visible = true;
            this.var_1219.visible = false;
            this.refreshFlatControllers();
            this.var_976.height = Util.getLowestPoint(this.var_976) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1218.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1218.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_982.height = Util.getLowestPoint(this.var_982) + 4;
         }
         this.var_1481.text = !!this.var_430 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1479.name,this.var_1218.name,this.var_982.name,this.var_976.name,this.var_1219.name,this.var_1478.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_646.setText(_loc1_.name);
         this.var_979.setText(_loc1_.description);
         this.var_794.setText("");
         this.var_975.setText("");
         ...
         this.setTag(this.var_793,_loc1_.tags[0]);
         this.setTag(this.var_795,_loc1_.tags[1]);
         if(this.var_974)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_537)
         {
            ...
            {
               this.var_537.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_537.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function method_9(param1:int, param2:int) : FlatCategory
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_646.getText();
         _loc2_.description = this.var_979.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_402;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_113)
         {
            _loc8_ = this.var_794.getText();
            _loc9_ = this.var_975.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_794.clearErrors();
               this.var_975.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         var _loc6_:FlatCategory = this.method_9(this.var_72.categoryId,_loc5_.selection);
         _loc2_.categoryId = _loc6_.nodeId;
         var _loc7_:IDropMenuWindow = this._window.findChildByName("maxvisitors") as IDropMenuWindow;
         _loc2_.maximumVisitors = 10 + _loc7_.selection * 5;
         _loc2_.allowPets = this.var_974.isSelected;
         _loc2_.allowFoodConsume = this.var_978.isSelected;
         _loc2_.allowWalkThrough = this.var_980.isSelected;
         _loc2_.hideWalls = this.var_537.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_793,_loc2_.tags);
         this.addTag(this.var_795,_loc2_.tags);
         this.clearErrors();
         this.var_977 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_303);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_72.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_303]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_222.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_222.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_222.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_222.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_222.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_222.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_222.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_222);
         this.var_222.findChildByName("ruler").visible = true;
         ...
         if(this.var_72.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_222,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_34,HabboWindowParam.const_58,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_303));
      }
