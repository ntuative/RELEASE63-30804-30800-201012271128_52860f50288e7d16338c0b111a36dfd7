package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2046:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2046 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_157 = IWindowContainer(param1.findChildByName("details_container"));
         }
         this.var_157.visible = true;
         Util.hideChildren(this.var_157);
         this.refreshRoomName(this.var_157,this.var_103);
         if(this.var_103.ownerName != "" && this.var_103.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_157,!!this.var_103.event ? this.getEventCtg(this.var_103.categoryId) : this.getRoomCtg(this.var_103.categoryId));
         this.refreshRoomDesc(this.var_157,this.var_103);
         this.refreshExtraCont();
         this.refreshInfo(this.var_157,"trading_allowed",this.var_103.allowTrading);
         this.refreshInfo(this.var_157,"doormode_doorbell",this.var_103.doorMode == 1);
         this.refreshInfo(this.var_157,"doormode_password",this.var_103.doorMode == 2);
         Util.moveChildrenToColumn(this.var_157,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         this.var_157.height = Util.getLowestPoint(this.var_157);
      }
      
      private function refreshOwnerName() : void
      {
         this.refreshTextWithCaption("roomowner",this.var_157,this.var_103.ownerName);
         var _loc1_:ITextWindow = ITextWindow(this.var_157.findChildByName("roomowner"));
         if(this.var_103.ownerName != "" && this.var_103.ownerName != "-")
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_157.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         this.var_1124.refreshTags(_loc1_,this.var_103.tags);
         ...
         this.var_2046.refreshThumbnail(_loc1_,this.var_103.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_253,Tabs.const_225,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
