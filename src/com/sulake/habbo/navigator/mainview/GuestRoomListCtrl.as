package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_453:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_453 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_513 = IScrollbarWindow(this.var_153.findChildByName("scroller"));
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_453.visible && this.var_2223)
            {
               return;
            }
            ...
            this.var_453.room = _loc4_;
            this.var_453.showPopup(param2);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(Util.method_7(param2))
            {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1290.tags[0];
            this.var_1290.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2224 - _loc2_.stageX);
         this.var_2224 = _loc2_.stageX;
         this.var_2223 = _loc3_ > 2;
      }
   }
}
