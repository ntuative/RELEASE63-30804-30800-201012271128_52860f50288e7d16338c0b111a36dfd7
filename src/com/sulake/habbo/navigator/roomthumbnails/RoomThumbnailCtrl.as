package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1689 = IButtonWindow(this.find("bg_tab"));
         this.var_1691 = IButtonWindow(this.find("top_tab"));
         this.var_1690 = IButtonWindow(this.find("obj_tab"));
         this.var_2366 = IWindowContainer(this.find("tile_grid"));
         this.var_2365 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1689,this.onBgTabButton);
         Util.setProcDirectly(this.var_1691,this.onTopTabButton);
         Util.setProcDirectly(this.var_1690,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_63.mode = ThumbnailEditorModel.const_56;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1689,this.var_63.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1691,this.var_63.mode != ThumbnailEditorModel.const_56);
         this.setEnabled(this.var_1690,this.var_63.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2365;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_63.mode == ThumbnailEditorModel.const_35);
         this.refreshEditImg(_loc1_,"edit_top",this.var_63.mode == ThumbnailEditorModel.const_56);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_458)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_34,HabboWindowParam.const_58,new Rectangle(0,0,param1.width,66)));
