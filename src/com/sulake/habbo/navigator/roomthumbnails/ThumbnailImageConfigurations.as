package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfigurations
   {
      ...
      public function ThumbnailImageConfigurations(param1:HabboNavigator)
      {
         ...
         this.var_1752 = this._navigator.getButtonImage("rico_selected");
      ...
      {
         var _loc4_:ThumbnailImageConfiguration = new ThumbnailImageConfiguration(this._navigator,param1,param2,param3,this.var_1752);
      ...
      {
         var _loc2_:Dictionary = this.var_1805[param1];
         if(_loc2_ == null)
         {
      ...
      {
         var _loc2_:Array = this.var_1806[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Array();
            this.var_1806[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
