package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_613:RoomInfoViewCtrl;
      
      private var var_1135:RoomCreateViewCtrl;
      ...
      private var var_794:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_613 = new RoomInfoViewCtrl(this);
         this.var_1135 = new RoomCreateViewCtrl(this);
         this.var_2046 = new RoomThumbnailRenderer(this);
         this.var_794 = new GuestRoomPasswordInput(this);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_613.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_289.startSearch(Tabs.const_253,Tabs.const_362,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_289.startSearch(Tabs.const_295,Tabs.const_219);
         this.var_409.getTab(Tabs.const_295).tabPageDecorator.tabSelected();
      }
